...
const HERO_IMAGES = [
  "/hotels/pomarosa/entrada-hotel.jpeg",
  "/hotels/pomarosa/habitacion-doble.jpeg",
  "/hotels/pomarosa/lobby.jpeg",
  "/hotels/pomarosa/recepcion.jpeg",
  "/hotels/pomarosa/cocina.jpeg",
];

const TICKER_ITEMS = ["4★ Estrellas", "7.9 Calificación", "943+ Reseñas", "Laureles · Medellín"];
...
const CARDS: CardData[] = [
  {
    ...
    href: "#motor-reservas",
    image: "/hotels/pomarosa/habitacion-doble.jpeg",
    primary: true,
    anchor: true,
  },
  {
    ...
    href: "https://wa.me/573146544069",
    image: "/hotels/pomarosa/lobby.jpeg",
    badge: "whatsapp",
  },
];
...
function BentoCard({ card, tall = false }: { card: CardData; tall?: boolean }) {
  ...
  return (
    ...
    >
      ...
      <img src={card.image} alt={card.label} style={{ position: "absolute", inset: 0, width: "100%", height: "100%", objectFit: "cover" }} />
      <div
    ...
    <main className="min-h-screen" style={{ background: "#0d0c0b" }}>
      <style>{`
        ...
        .pm-ticker-track {
          display: flex;
          width: max-content;
          animation: pm-ticker 22s linear infinite;
        }
      ...
      <div className="max-w-[430px] mx-auto w-full">
        ...
        <section id="motor-reservas" className="px-4 pb-6" style={{ background: "#0d0c0b" }}>
          ...
          >
            <iframe
              src="https://sys.hosroom.com/booking/179-hotel-pomarosa"
              width="100%"
              height="580"
              style={{ border: 0, display: "block", colorScheme: "light" }}
              title="Motor de reservas Hotel Poma Rosa"
              loading="lazy"
              allow="payment"
            />
          </motion.div>
